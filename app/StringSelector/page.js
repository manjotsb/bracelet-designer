...
const STRING_TYPES = [
  { id: 'with-clasp', name: 'With Clasp', image: '/bracelet/bracelet-with-clasp.png' },
  { id: 'no-clasp', name: 'No Clasp', image: '/bracelet/bracelet-no-clasp.png' },
];

const StringSelector = ({ selectedString, onSelect }) => {
  return (
